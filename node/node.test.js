...
test('depvary', () =>
{
    ...
    expect( t.c.hearingFromObjects ).toContain( i1 );
    expect( t.c.hearingFromObjects ).toContain( t.mode );
    expect( t.c.hearingFromObjects ).not.toContain( t.i2 );
    ...
    expect( t.c.hearingFromObjects ).toContain( i1 );
    expect( t.c.hearingFromObjects ).toContain( t.mode );
    expect( t.c.hearingFromObjects ).toContain( t.i2 );
});
