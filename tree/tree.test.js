...
test('depvary', () =>
{
    ...
    expect( T.c[NODE].hearingFromObjects ).toContain( T.i1[NODE] );
    expect( T.c[NODE].hearingFromObjects ).toContain( T.mode[NODE] );
    expect( T.c[NODE].hearingFromObjects ).not.toContain( T.i2[NODE] );
    ...
    expect( T.c[NODE].hearingFromObjects ).toContain( T.i1[NODE] );
    expect( T.c[NODE].hearingFromObjects ).toContain( T.mode[NODE] );
    expect( T.c[NODE].hearingFromObjects ).toContain( T.i2[NODE] );
...
test('nest', () =>
{
    ...
    expect( t.c.hearingFromObjects ).toContain( t.s.x );
    expect( t.c.hearingFromObjects ).toContain( t.i );
});
