...
test('depvary', () =>
{
    ...
    expect( T.c[NODE].deps ).toContain( T.i1[NODE] );
    expect( T.c[NODE].deps ).toContain( T.mode[NODE] );
    expect( T.c[NODE].deps ).not.toContain( T.i2[NODE] );
    ...
    expect( T.c[NODE].deps ).toContain( T.i1[NODE] );
    expect( T.c[NODE].deps ).toContain( T.mode[NODE] );
    expect( T.c[NODE].deps ).toContain( T.i2[NODE] );
